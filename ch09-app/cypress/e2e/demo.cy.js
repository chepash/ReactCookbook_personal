      ...
      JSON.stringify([
        {
          ...
          description: 'Check for available domain names',
          context: 'research',
        },
        {
          id: '2',
          title: 'Call accountant',
          description: 'Ask about international tax rules',
          context: 'phone',
        },
        {
          id: '3',
          title: 'Business office',
          description: 'Look at the co-working space',
          context: 'car',
        },
        {
          id: '4',
          title: 'Model articles',
          description: 'Purchase and modify model articles',
          context: 'shopping',
        },
        {
          id: '5',
          title: 'Register company',
          description: 'Complete registration details online',
          context: 'admin',
        },
        {
          id: '6',
          title: 'Sales tax registration',
          description: 'Ask accountant',
          context: 'phone',
        },
        ...
        { id: '18', title: 'CI server', description: 'Build CI server', context: 'coding' },
        {
          id: '19',
          title: 'Charts',
          description: 'Buy charts package license',
          context: 'shopping',
        },
